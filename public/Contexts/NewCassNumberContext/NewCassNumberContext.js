...
import { APP_URL, CANCER_CODE, GENDERS } from "../../Constants/Variables";
...
export const NewCasesNumberContextProvider = (props) => {
  ...
  const dataUrl = `${APP_URL}/analytics/events/aggregate/Gx43mgh4uxr.json?dimension=ou:${ouSelected}&dimension=pe:LAST_MONTH&dimension=k8bX0rJnw6o.CJdB3XK2YSa:IN:Male;Female&dimension=k8bX0rJnw6o.rnAfX4JDuPY&stage=k8bX0rJnw6o&displayProperty=NAME&outputType=EVENT&outputIdScheme=NAME`;
